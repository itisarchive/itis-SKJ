...
Repository that contains solutions to the exercises for the SKJ (Computer Networks and Network Programming in Java)
socket programming practical classes, taught by Piotr Smażyński during studies on [PJAIT](https://www.pja.edu.pl/en/).
...
repository [here](https://github.com/itischrisd/DistributedDB).
